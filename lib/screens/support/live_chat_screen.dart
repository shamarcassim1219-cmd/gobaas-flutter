...
class _LiveChatScreenState extends State<LiveChatScreen> {
  ...
  /// always starting blank - closing and reopening this screen
  /// mid-conversation should still show what was already said.
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index == _messages.length) {
                          return _buildClosedInListNotice();
                        }
  ...
  /// Rendered as the last item inside the message list itself
  /// (rather than a separate banner above the input bar), so it
  /// reads like a system message in the conversation's own timeline
  /// - "Chat closed" right where the conversation left off.
  Widget _buildClosedInListNotice() {
    return Padding(
