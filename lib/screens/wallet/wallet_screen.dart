        ...
        children: [
          ...
          if (pending > 0) ...[
            ...
            Container(
              ...
              child: Text(
                'Pending: ${formatMoney(pending, isInternational: _isInternational)}',
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              onPressed: () {
                // TODO: Navigator.push to a TopUp screen/dialog once
                // the PayHere/PayPal in-app webview flow is built.
              },
              ...
              children: [
                ...
                if (isPending) ...[
                  ...
                  Container(
                    ...
                    child: const Text(
                      'PENDING',
                      style: TextStyle(fontSize: 9.5, fontWeight: FontWeight.w800, color: AppColors.warning),
                    ),
                  ),
                ],
              ],
