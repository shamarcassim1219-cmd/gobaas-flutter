...
class _LanguageScreenState extends State<LanguageScreen> {
  ...
  Future<void> _continue() async {
    ...
    try {
      ...
      // A token can only be registered once an authenticated
      // session exists - this is the guest-session equivalent of
      // the call in main.dart's _StartupGate (which handles every
      // later launch, once a session already exists).
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              const Spacer(),
              const BrandLogo(fontSize: 32, prefix: 'MY'),
