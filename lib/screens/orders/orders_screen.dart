...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  Future<void> _openReviewDialog(MybaasOrder order) async {
    ...
    if (order.professionalId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('This order has no assigned Baas to review.')),
      );
      return;
    }
    ...
    try {
      ...
      // review-submission contract can be confirmed. Once
  ...
  Widget _buildOrderCard(MybaasOrder order) {
    ...
    return InkWell(
      onTap: (isCompleted && !alreadyReviewed) ? () => _openReviewDialog(order) : null,
            ...
            if (isCompleted) ...[
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    alreadyReviewed ? 'Reviewed' : 'Tap to leave a review',
                    style: TextStyle(
                      fontSize: 12,
