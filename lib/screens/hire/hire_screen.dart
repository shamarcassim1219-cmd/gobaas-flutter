...
class _HireScreenState extends State<HireScreen> {
  ...
  String _paymentMethod = 'pay_direct'; // 'pay_now' disabled for now - Coming Soon
  ...
  Widget _paymentOption({
    ...
    final selected = !disabled && _paymentMethod == value;

    return InkWell(
      onTap: disabled ? _showComingSoon : () => setState(() => _paymentMethod = value),
      borderRadius: BorderRadius.circular(AppSpacing.radiusMd),
      child: Opacity(
