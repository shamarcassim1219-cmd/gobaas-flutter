...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> _onTapNotification(MybaasNotification notification) async {
    ...
    // TODO: route by notification.type once the relevant destination
    // screens exist (e.g. type == "order" -> OrdersScreen,
    // type == "payment_failed" -> resume payment for notification.orderId).
  }
