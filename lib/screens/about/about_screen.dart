...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('About MYBAAS')),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text(
              'MYBAAS connects you with trusted, verified professionals '
            ...
            const SizedBox(height: 32),
            const Text(
              'Every Baas on MYBAAS goes through an identity verification '
