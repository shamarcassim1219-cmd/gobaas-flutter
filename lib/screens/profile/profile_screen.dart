...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _logout() async {
    ...
    // Same pattern as first launch - straight back into a fresh
    // guest session rather than a login/language screen nobody
    // asked to see yet.
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    const Text(
                      'Login or register to hire a Baas and save your details.',
